...
const homeData = [
  {
    title: "Mon parcours",
    texts: [
      "Je suis actuellement développeur chez Polyconseil. J'apporte une vraie passion pour le développement mais aussi un profil atypique enrichi par ma première vie professionnelle.",
