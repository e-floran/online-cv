...
const homeData = [
  {
    title: "Mon parcours",
    texts: [
      "Je suis actuellement développeur chez Salsa. J'apporte une vraie passion pour le développement mais aussi un profil atypique enrichi par ma première vie professionnelle.",
  ...
  },
  {
    ...
    texts: [
      "L'apprentissage est pour moi un élément moteur, que ce soit apprendre aux autres ou bien apprendre des autres. C'est, à mon sens, un élément clé de la réussite d'une équipe. J'aime également écrire. Que ce soit du code ou un langage plus traditionnel.",
